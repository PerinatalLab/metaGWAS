...
snakemake <- Snakemake(
    input = list('Training/Data/GAraw_pheno_training.txt', '/mnt/work2/chrisf/meta_gest_duration/New_PRS/HapMap3_snps/EUR_hapmap_freq_allchr.txt', 'Training/Data/noMOBA_Maternal_nodups_GAraw.txt', 'Training/Data/training/Filtered_Merged/training_genotypes.bed'),
    output = list('Training/Results/training/info_snp', 'Training/Results/training/fam.order', 'Training/Results/training/h2_est', 'Training/Results/training/beta_grid', 'Training/Results/training/grid.param', 'Training/Results/training/pred_grid', 'Training/Results/training/result_grid', 'Training/Results/training/grid_prs', 'Training/Results/training/r2_matrix', 'Training/Results/training/map', 'Training/Data/training/Filtered_Merged/training_genotypes.bk'),
    params = list('Training/Data/training/Filtered_Merged/training_genotypes.rds'),
    wildcards = list('training', "batch" = 'training'),
    threads = 20,
    log = list(),
    resources = list(),
    config = list(),
